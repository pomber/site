...
function TerminalPanel({ code, height }) {
  return !height ? null : (
    <div
      style={{
        position: "absolute",
  ...
  return (
    ...
    >
      <img
        src={GitHubIcon}
        title="Open on GitHub"
        style={{ width: "16px", padding: "0 8px", height: "100%" }}
      />
    </a>
  )
}
...
function CopyAllButton() {
  return (
    <a href="#" title="Copy All" style={{ display: "block" }}>
      <img
        src={CopyIcon}
        title="Copy All"
        fill="#A3ACB9"
        style={{ width: "16px", padding: "0 4px 0 8px", height: "100%" }}
      />
    </a>
  )
}
