...
import {
  ...
  Browser,
  Editor,
} from "../../src/components/hike"

<HikeWave>

<View><Browser url="https://some.now.sh" height={300} /></View>
...
<View><Editor height={350} /></View>

We first initialize a new project using NextJS and React (and a few more dependencies that we're going to use later). If you are coding along run this on an empty folder.
...
<View>
  <Editor height={350} />
  <Browser url="https://some.now.sh" height={300} />
</View>
