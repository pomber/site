...
We wrote code similar to React's.
Code doesnt have many optimizations.
...
- Render the whole tree instead of bail out.
- On the commit phase we are walking the whole fiber tree. To avoid this, React keeps a linked list with all the fibers that have changes.
